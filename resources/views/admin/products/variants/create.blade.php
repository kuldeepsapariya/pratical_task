...
<div class="p-6">
    <div class="max-w-3xl mx-auto">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900">Add New Variant</h1>
            <p class="mt-1 text-sm text-gray-600">Create a new variant for {{ $product->name }}</p>
        </div>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="name" id="name" required 
                            ...
                            placeholder="e.g., Standard, Premium, Glossy">
                        @error('name')
                    ...
                    <div>
                        <label for="image" class="block text-sm font-medium text-gray-700 mb-2">Variant Image</label>
